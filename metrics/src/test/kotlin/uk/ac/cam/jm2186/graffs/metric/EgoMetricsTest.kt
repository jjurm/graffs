...
internal class EgoMetricsTest : TestOnGraph() {
    ...
    fun testEgo1EdgesMetric() {
        ...
        GraphAssert.assertGraphEquals(
            ...
            3{EE=9} [3->1_3]
            4{EE=8} [4->3_4,4->2_4]
            5{EE=13} [5->0_5,5->3_5,5->4_5]
            6{EE=2} [6->2_6]
            7{EE=8} [7->2_7,7->3_7,7->4_7,7->5_7]
            8{EE=6} [8->0_8,8->5_8]
    ...
    fun testEgo2NodesMetric() {
        ...
        GraphAssert.assertGraphEquals(
            ...
            3{E2=10} [3->1_3]
            4{E2=10} [4->3_4,4->2_4]
            5{E2=10} [5->0_5,5->3_5,5->4_5]
            6{E2=9} [6->2_6]
            7{E2=10} [7->2_7,7->3_7,7->4_7,7->5_7]
            8{E2=9} [8->0_8,8->5_8]
    ...
    fun testEgoRatioMetric() {
        ...
        GraphAssert.assertGraphEquals(
            ...
            5{E2=10,ER=0.7} [5->0_5,5->3_5,5->4_5]
            6{E2=9,ER=0.3333333333333333} [6->2_6]
            7{E2=10,ER=0.5} [7->2_7,7->3_7,7->4_7,7->5_7]
            8{E2=9,ER=0.4444444444444444} [8->0_8,8->5_8]
